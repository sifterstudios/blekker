  ...
  group('AuthBloc', () {
    blocTest<AuthBloc, AuthState>(
      ...
      build: () {
        ...
        return AuthBloc(userSignup: mockUserSignup, userLogin: mockUserLogin);
      },
      act: (bloc) async {
        bloc
      ...
      expect: () async => <AuthState>[
        ...
        AuthState.signupSuccess(mockUserEntity),
      ],
    );
    blocTest<AuthBloc, AuthState>(
